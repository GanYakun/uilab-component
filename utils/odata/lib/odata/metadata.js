...
var schema = {
  elements: {
    ...
    ActionImport: schemaElement(/*attributes*/['Name', 'Action', 'EntitySet', 'Annotation*']),
    ...
    AnnotationPath: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    ...
    And: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Or: schemaElement(/*attributes*/ null, /*elements*/['Eq*'], /*text*/ true),
    Not: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Eq: schemaElement(/*attributes*/ null, /*elements*/['Path*', 'String*', 'Bool*'], /*text*/ true),
    Ne: schemaElement(/*attributes*/ null, /*elements*/['Path*', 'String*', 'Bool*'], /*text*/ true),
    Gt: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Ge: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Lt: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Le: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Binary: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Bool: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Cast: schemaElement(/*attributes*/['Type'], /*elements*/['Path*', 'Annotation*']),
    ...
    Date: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    ...
    Duration: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    ...
    EnumMember: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    ...
    If: schemaElement(/*attributes*/ null, /*elements*/['Path*', 'String*', 'Annotation*', 'Eq*', 'Ne*', 'Bool*', 'Or*']),
    ...
    Member: schemaElement(/*attributes*/['Name', 'Value'], /*element*/['Annotation*']),
    ...
    NavigationPropertyBinding: schemaElement(/*attributes*/['Path', 'Target']),
    NavigationPropertyPath: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    Null: schemaElement(/*attributes*/ null, /*elements*/['Annotation*']),
    OnDelete: schemaElement(/*attributes*/['Action'], /*elements*/['Annotation*']),
    ...
    PropertyPath: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
    PropertyRef: schemaElement(/*attributes*/['Name', 'Alias']),
    PropertyValue: schemaElement(
      /*attributes*/['Property', 'Path', 'String', 'Bool', 'AnnotationPath', 'PropertyPath', 'EnumMember', 'Decimal', 'Int', 'NavigationPropertyPath'],
      /*elements*/[
        'Binary*',
        'Bool*',
        'Date*',
    ...
    TimeOfDay: schemaElement(/*attributes*/ null, /*elements*/ null, /*text*/ true),
...
exports.metadataHandler = odataHandler.handler(
  metadataParser,
  null,
  xmlMediaType,
