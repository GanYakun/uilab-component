...
// var odataNet      = exports.net       = require('./odata/net-wechat.js');
...
function dispatchHandler(handlerMethod, requestOrResponse, context) {
  ...
  for (
    ...
    i < len && !handlers[i][handlerMethod](requestOrResponse, context);
    i++
  ) {}
...
exports.request = function (request, success, error, handler, httpClient, metadata) {
  ...
  request.recognizeDates = utils.defined(
    request.recognizeDates,
    odataJson.jsonHandler.recognizeDates,
  );
  request.callbackParameterName = utils.defined(
    request.callbackParameterName,
    odataNet.defaultHttpClient.callbackParameterName,
  );
  request.formatQueryString = utils.defined(
    request.formatQueryString,
    odataNet.defaultHttpClient.formatQueryString,
  );
  request.enableJsonpCallback = utils.defined(
    request.enableJsonpCallback,
