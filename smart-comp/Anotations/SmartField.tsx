 ...
 * @LastEditTime: 2023-11-27 12:33:11
...
const getConfig = async (params) => {
    ...
    const { displayValue, currentValue } = Utils.getFieldReadonlyTextAndCurrentValue(record, path, currentAnnotations, currentPropertyType)
    const label = Utils.getLabelByAnnotation(currentAnnotations)
    //调试用
    if(path==='roleTypeId'){
        console.log({
