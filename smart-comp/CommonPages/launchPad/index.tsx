 ...
 * @LastEditTime: 2023-12-22 14:38:15
...
const LaunchPad: React.FC = () => {
  ...
  const tagEnum = {
    ...
    'supplierapprove-managebyapplication': <Statistic title="To be registered" value={60} prefix={<FileSyncOutlined />} valueStyle={{ color: '#0a6ed1' }} />,
